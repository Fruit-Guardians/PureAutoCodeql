 ...
 * Supports both Windows (cmd.exe) and Unix-like systems.
 */
function escapeShellArg(arg: string): string {
  ...
  if (isWindows) {
    ...
    // Escape: " -> "" and \ -> \\
    // If the string contains spaces or special chars, wrap in double quotes
 ...
 * Converts relative paths to absolute paths and normalizes path separators.
 */
  ...
  try {
    ...
    switch (toolName) {
      case "search": {
        ...
        // Add pattern and path (use normalized absolute path)
