...
@Component
public class EvacuationEntityInventoryService extends InventoryBrowserService {
   @Autowired
   ...
   protected List<InventoryEntryData> createRemoteNodeModel(List<ManagedObjectReference> nodeRefs, PscConnectionDetails pscDetails) {
      throw new NotImplementedException("Evacuation entity inventory does not support remote VC!");
   }
   ...
   protected InventoryEntryData createDSModel(ResultItem item) {
      ...
      for(int var3 = 0; var3 < var4; ++var3) {
         ...
         if (prop.propertyName.equals("config.vsanHostConfig.enabled") && Boolean.FALSE.equals(prop.value)) {
            return null;
         }
      }
