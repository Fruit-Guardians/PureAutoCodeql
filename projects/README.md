...
5. 运行 `Analyze.py --case <case-id>` 或 `Analyze_Python.py --case <case-id>` 来初始化情报并开始分析。
...
5. Run `Analyze.py --case <case-id>` or `Analyze_Python.py --case <case-id>` to seed intelligence and start the analysis.
